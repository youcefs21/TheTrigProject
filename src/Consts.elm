...
cols = {
    ...
    red             = rgb 237 66  69,
    bananaYellow    = rgb 255 220 94,
    anotherGreen    = rgb 66 245 96}
...
lightTheme = {
    ...
    adj           = cols.blurple,
    opp           = cols.red,
    hyp           = cols.nitroBlue, --notQuiteBlack,
    tan           = cols.braveryPurple, --streamerPurple,
    ...
    tutWords      = cols.bananaYellow, --hypesquadYellow,
    dots          = cols.darkGrey,
...
darkTheme = {
    ...
    adj           = cols.blurple,
    opp           = cols.red,
    hyp           = cols.nitroBlue, --lightNitroGrey,
